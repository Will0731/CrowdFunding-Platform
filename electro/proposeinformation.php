		...
		<!--section-->
				<section style="font-family: '微軟正黑體'">
					<div class="container btn-group" style="text-align: center;margin-top: 20px;position: relative;left: 189.6px">	
						<a href = "#" style="font-size:20px;" class="col-md-3 btn btn-danger">專案大綱</a>
						<a href = "#" style="font-size:20px;" class="col-md-3 btn btn-warning">專案內容</a>
						<a href = "#" style="font-size:20px;" class="col-md-3 btn btn-success">回饋設定</a>
						<a href = "#" style="font-size:20px;" class="col-md-3 btn btn-primary">提案資料</a>
					</div>
				</section>
				<section style="font-family: '微軟正黑體'">
						...
						<form style="margin-bottom:20px;">
							<div class="container">
								<div class="row">
									<div class="col" style="margin-left: 360px">
										...
										<input type="text" name="proposer" maxlength="40" placeholder="請輸入40字以內的標題">
										<br>
							...
							<div align="center" style="margin-top: 20px">	
							 	<button type="reset" class="btn btn-danger btn-lg  text-center">
							 		提交專案
							 	</button>
							</div>     
						</form>
