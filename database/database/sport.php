...
/*    .highlight>li>a:hover, .highlight>li>a:focus {
    ...
    <div class="section" style="margin-top: 40px;">
        <div class="container">
            <span style="font-size: 40px; font-family: 微軟正黑體; font-weight: bold;">|運動</span>
        </div>        
    </div>
                            ...
                            <div class="products-tabs">
                                ...
                                <div id="tab1" class="tab-pane active">
                                    <div class="products-slick" data-nav="#slick-nav-1">
                                        ...
                                        <!-- product -->
                                        <?php 
                                        $sql="SELECT pid FROM project NATURAL JOIN p_summary NATURAL JOIN p_content NATURAL JOIN feedback_setting NATURAL JOIN proposer_info WHERE category='運動';";
