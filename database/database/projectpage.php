	...
	?>
      ...
      $people = mysqli_fetch_array($result1);
                ...
                <div class="col-sm-4">
                  ...
                  if(isset($_SESSION["u_id"]) && $_SESSION["u_id"] != null){                
                    ...
                    if($collect[0]==$row['pid']){
                      ...
                      echo '<a href="login_page.php" class="btn btn-default btn-block ">加入收藏</a>';
                    }
                echo '</div>
 			</div>
		</div>
			...
			<div class="container">
  				<div class="col-sm-8" style="border-right-style: groove; border-width: 1px;">
    				<ul class="nav navbar-nav nav-fill">
      					<li class="active nav-item midnav" style="background-color: #e6e6e6;"><a href="projectpage.php?select_project='.$row["pid"].'#p_content" style="font-weight: bold; color: #ff3333;">專案內容</a></li>
      					...
      					<li class="active nav-item midnav"><a href="project_support.php?select_project='.$row["pid"].'#support" style="font-weight: bold; color: #ff3333;">支持者</a></li>
    				</ul>
    			</div>
    			<div class="col-sm-4" id="p_content">
		...
		<div class="section" >
			<div class="container">					
				<div class="col-sm-8">
                    <h1 class="title" style="font-family:微軟正黑體; text-align: center; font-weight: bold;">專案內容</h1>
